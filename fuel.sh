...
echo "${KEY_OUTPUT}"
read -p "请输入上方生成的私钥，并在开头加上0x: " SECRET

# 用户输入节点名称和RPC地址
read -p "设置节点名称: " NODE_NAME
echo "在app.infura.io/signup注册并获取你的ETH Sepolia RPC地址"
read -p "输入您的ETH Sepolia RPC地址: " RPC
